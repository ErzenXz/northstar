  ...
  return (
    <main className="auth-page">
      <section className="auth-card">
        ...
        <p className="auth-switch">New to Origin? <Link href="/sign-up">Create your forge</Link></p>
      </section>
      <aside className="auth-aside"><div><span>OPEN BY DESIGN</span><blockquote>“The code, project memory, and agent history should belong to the people building the product.”</blockquote><p>Self-host the same core that powers Origin Cloud.</p></div></aside>
    </main>
  );
}
